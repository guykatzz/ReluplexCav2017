...
int main( int argc, char **argv )
{
    ...
    try
    {
        ...
        // Range min: 36000
        // Range max: 60760
        reluplex.setLowerBound( nodeToVars[Index(0, 0, true)], normalizeInput( 0, 36000, neuralNetwork ) );
        ...
        // Speed own min: 900
        // Speed own max: 1200
        reluplex.setLowerBound( nodeToVars[Index(0, 3, true)], normalizeInput( 3, 900, neuralNetwork ) );
